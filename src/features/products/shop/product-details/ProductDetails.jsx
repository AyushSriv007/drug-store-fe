                                            ...
                                            <fieldset className="variant__input--fieldset">
                                                ...
                                                <ul className="variant__size d-flex">
                                                    <li className="variant__size--list">
                                                        ...
                                                        <label className="variant__size--value red" for="weight4">5 kg</label>
                                                    </li>
                                                    <li className="variant__size--list">
                                                        <input id="weight5" name="weight" type="radio" />
                                                        <label className="variant__size--value red" for="weight5">3 kg</label>
                                                    </li>
                                                    <li className="variant__size--list">
                                                        <input id="weight6" name="weight" type="radio" />
                                                        <label className="variant__size--value red" for="weight6">2 kg</label>
                                                    </li>
                                                </ul>
                                            </fieldset>
                                        </div>
